...
(function() {
    var provider = app.data.avengersAppBackend = new Everlive({
            offlineStorage: true,
            apiKey: 'H2h9QWfda4zxYVEt',
    ...
    document.addEventListener('online', function() {
        app.data.avengersAppBackend.offline(false);
        app.data.avengersAppBackend.sync();
    });

    document.addEventListener('offline', function() {
        app.data.avengersAppBackend.offline(true);
    });

}());

// START_CUSTOM_CODE_avengersAppBackend
// END_CUSTOM_CODE_avengersAppBackend